<div class="section-element list-content text-list-hover">
    <div class="container">
        ...
        <div class="title">
            <h4 data-aos="fade-left" data-aos-delay="400"><?php echo get_sub_field('title'); ?></h4>
        </div>
                ...
                <div class="wrap-item-list">
                    ...
                    <?php while (have_rows('content')) : the_row(); ?>
                        <div class="item-wrapper-list">
                            ...
                            <?php if ($image) : ?>
                                <img data-aos="fade-up" data-aos-delay="<?php echo 800 * $itemNumber; ?>" data-aos-duration="3000" class="img-fluid image-list-content" width="400" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>">
                            <?php endif; ?>
                        </div>
                        <?php $itemNumber++; ?>
                    <?php endwhile; ?>
